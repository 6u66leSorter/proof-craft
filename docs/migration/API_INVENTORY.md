...
| --- | --- | --- | --- | --- | --- |
| GET | `/health` | публичный | Проверка процесса | low | covered |
| GET | `/api/session` | Telegram, VK или web-session | Пользователь, роли, профили, рейтинг, преподаватели, непрочитанные уведомления | high | covered |
...
| Метод | Путь | Доступ | Основная логика | Риск | Статус |
| --- | --- | --- | --- | --- | --- |
| GET | `/api/notifications` | пользователь | Список и число непрочитанных | medium | legacy |
...
| GET | `/api/guest/homeworks/:homeworkId/attachments/:attachmentId/file` | публичный | Дополнительный файл работы | high | legacy |
...
| GET | `/api/student/me/avatar` | ученик | Собственный аватар | medium | legacy |
